#' Add twrite theme to ggplot chart
#'
#' This function allows you to add the twrite theme to your ggplot-graphics.
#' @keywords twrite_style
...
twrite_style <- function(font = "Arial") {
...
#' Arrange alignment and save Twrite ggplot chart
#'
#' Running this function will save your plot with the correct guidelines for publication for a Twrite graphic.
...
finalise_plot <- function(plot_name,
                          ...
                          width_pixels=640,
                          height_pixels=450,
                          logo_image_path = file.path(system.file("extdata", package = 'twrite'),"logo.png")) {
